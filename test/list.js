...
const fixture = [{ id: 1, foo: 'bar' }, { id: 2, foo: 'barbis' }];
...
test('withList: should pass the stProps as second argument', async (t) => {
    ...
    let stProps = null;
    const comp = withListChange((props, other) => {
        stProps = other;
